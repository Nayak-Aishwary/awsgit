...
<body>
	<div>
		...
		<div id="loginbox" style="margin-top: 25px; margin-left: 200px"
			...
			<div class="panel panel-info">
				...
				<div style="padding-top: 5px; padding-left: 100px"
					class="panel-body">
					<form:form action="${pageContext.request.contextPath}/driverdetails" method="GET" class="form-horizontal">
					...
					<form:form action="addDriver" modelAttribute="driver" method="POST"
						...
						<table>
								...
								<td>
									<div style="margin-bottom: 25px" class="input-group">
										<span class="input-group-addon"><i
											...
											name="baseFarePrice" required="required"
											placeholder="Basefare Price" class="form-control">
									</div>
								</td>
								...
								<td>
									<div style="margin-bottom: 25px" class="input-group">
										<span class="input-group-addon"><i
											...
											placeholder="Basefare Distance" class="form-control">
									</div>
								</td>
							...
							<tr>
								<td>
									<div style="margin-top: 10px; align: center" class="form-group">
										<div class="col-sm-6 controls">
